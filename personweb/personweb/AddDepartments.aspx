...
<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddDepartments.aspx.cs" Inherits="personweb.AddDepartments" %>
    ...
    <table  style="border: 1px groove #000099; width:90%" class="tableborder" dir="rtl">
                 <tr class="tableheaderback">
                    <td colspan="3"   style=" height: 40px;" class="tableheaderback" >
                        <asp:Label ID="Label4" runat="server" CssClass="lblheader" Text="<%$ Resources:DashboardText,AddDepartment%>"></asp:Label>
                     </td>
                </tr>
                <tr>
                   <td style="width: 144px">
                       <asp:Label ID="Label3" runat="server" Text="<%$ Resources:DashboardText,DepartmentName%>"  CssClass="font_custom16"></asp:Label>
                    </td>
