<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddEduFields.aspx.cs" Inherits="personweb.AddEduFields" %>
    ...
    <table  style="border: 1px groove #000099; width:90%" class="tableborder" dir="rtl">
                <tr class="tableheaderback">
                    <td colspan="3"   style=" height: 40px;" class="tableheaderback" >
                        <asp:Label ID="Label4" runat="server" CssClass="lblheader" Text="<%$ Resources:DashboardText,AddField%>" ></asp:Label>
                     </td>
                </tr>
                <tr>
                   <td style="width: 77px">
                       <asp:Label ID="Label3" runat="server" Text="<%$ Resources:DashboardText,FieldName%>"  CssClass="font_custom16"></asp:Label>
                    </td>
