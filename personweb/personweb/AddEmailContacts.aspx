<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddEmailContacts.aspx.cs" Inherits="personweb.AddEmailContacts" %>
      ...
      <table  style="border: 1px groove #000099; width:90%" class="tableborder" dir="rtl">
                <tr class="tableheaderback">
                    <td colspan="3"   style=" height: 40px;" class="tableheaderback" >
                        <asp:Label ID="Label7" runat="server" CssClass="lblheader" Text="<%$ Resources:DashboardText,AddEmailContact%>"></asp:Label>
                     </td>
                </tr>
                <tr>
