<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddEmployees.aspx.cs" Inherits="personweb.AddEmployees" %>
    ...
    <table  style="border: 1px groove #000099; width:90%" class="tableborder" dir="rtl">
                ...
                <tr class="tableheaderback">
                    <td colspan="3"   style=" height: 40px;" class="tableheaderback" >
                        <asp:Label ID="Label4" runat="server" CssClass="lblheader" Text="<%$ Resources:DashboardText,AddEmploye%>"></asp:Label>
                     </td>
                </tr>
                ...
                <tr>
                   ...
                   <td style="width: 224px; height: 54px;" class="tdheight">
                       <asp:TextBox ID="txtpass" runat="server" TextMode="Password" Width="108px"></asp:TextBox>
                    </td>
