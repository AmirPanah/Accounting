<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddStudents.aspx.cs" Inherits="personweb.AddStudents" %>
     ...
     <table  style="border: 1px groove #000099; width:90%" class="tableborder" dir="rtl">
                 ...
                 <tr class="tableheaderback">
                    <td colspan="3"   style=" height: 40px;" class="tableheaderback" >
                        <asp:Label ID="Label17" runat="server" CssClass="lblheader" Text="<%$ Resources:DashboardText,AddStudent%>"></asp:Label>
                     </td>
                </tr>
                <tr>
                ...
                <tr>
                   ...
                   <td style="width: 224px; height: 41px;" class="tdheight">
                       <asp:DropDownList ID="ddllevel" runat="server" Height="18px" Width="109px">
                       </asp:DropDownList>
                    </td>
