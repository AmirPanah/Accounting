<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EduTendenciesManagment.aspx.cs" Inherits="personweb.EduTendenciesManageraspx" %>
     ...
     <table style="border: 1px groove #000099; width: 90%" class="tableborder" dir="rtl">
                 ...
                 <tr class="tableheaderback">
                    <td   style=" height: 40px;" class="tableheaderback" >
                        <asp:Label ID="Label4" runat="server" CssClass="lblheader" Text="<%$ Resources:DashboardText,ManageEduTendency%>"></asp:Label>
                     </td>
                </tr>
                ...
                <tr>
                        ...
                        <asp:GridView ID="GridView1" runat="server" OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False" PageSize="5" Width="90%" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="True">
                            ...
                            <Columns>
                                <asp:BoundField DataField="TendencyID" HeaderText="کد گرایش " >
                                <ItemStyle HorizontalAlign="Center" Width="75px" />
                               </asp:BoundField>
                                <asp:BoundField DataField="TendencyTitle" HeaderText="نام گرایش "  >
                                <ItemStyle HorizontalAlign="Center" Width="75px" />
                               </asp:BoundField>
                               <asp:BoundField DataField="FieldTitle" HeaderText="نام  رشته " >
                                <ItemStyle HorizontalAlign="Center" Width="75px" />
                               </asp:BoundField>
                                
                                <asp:TemplateField HeaderText="ویرایش">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="HyperLink1" runat="server" ImageUrl="~/Icons/EditIcon.png" Target="_blank" NavigateUrl='<%#"EditEduTendency/" + Eval("TendencyID").ToString() %>'>HyperLink</asp:HyperLink>
                                    </ItemTemplate>
          ...
          <tr>
                 ...
                 <tr>
                    <td>
                        ...
                        <asp:Button ID="Button1" runat="server" Text="<%$ Resources:DashboardText,InsertEduTendency %>" OnClick="Button1_Click" CssClass="pagebutton"/>
                 ...
                 <tr>
                    <td>
                        ...
                        <asp:DropDownList ID="DropDownList1" runat="server" Height="16px" Width="79px">
                            <asp:ListItem Value="0">کد گرایش</asp:ListItem>
                            <asp:ListItem Value="1">نام&nbsp; گرایش</asp:ListItem>
                            <asp:ListItem Value="2">نام&nbsp; رشته</asp:ListItem>
                        </asp:DropDownList>
