<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EmployeesUpdate.aspx.cs" Inherits="personweb.EmployeesUpdateaspx" %>
     ...
     <table  style="border: 1px groove #000099; width:90%" class="tableborder" dir="rtl">
                 ...
                 <tr class="tableheaderback">
                    <td colspan="3"   style=" height: 40px;" class="tableheaderback" >
                        <asp:Label ID="Label4" runat="server" CssClass="lblheader" Text="<%$ Resources:DashboardText,EditEmploye%>"></asp:Label>
                     </td>
                </tr>
                <tr>
                ...
                <tr>
                   <td style="width: 144px; height: 40px;">
                       <asp:Label ID="Label16" runat="server" Text=  "کد کارمند" CssClass="font_custom16"></asp:Label>
                    </td>
                   <td style="width: 96px; height: 40px;" class="tdheight">
                ...
                <tr>
                   ...
                   <td style="width: 96px; height: 40px;" class="tdheight">
                       ...
                       &nbsp;<asp:Label ID="lbldep" runat="server" ForeColor="Red" Text="Label"></asp:Label>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <td style="height: 40px">
                        ...
                        <asp:DropDownList ID="ddldep" runat="server" Height="16px" Width="106px" OnSelectedIndexChanged="ddldep_SelectedIndexChanged" AutoPostBack="True">
                       </asp:DropDownList>
                ...
                <tr>
                   <td style="width: 144px; height: 40px;">
                       <asp:Label ID="Label10" runat="server" Text="<%$ Resources:DashboardText,RoleName%>"  CssClass="font_custom16"></asp:Label>
                    </td>
                   <td style="width: 96px; height: 40px;" class="tdheight">
                       <asp:Label ID="lblrole" runat="server" ForeColor="Red" Text="Label"></asp:Label>
                    </td>
                    <td style="height: 40px">
                       <asp:DropDownList ID="ddlrole" runat="server" Height="19px" Width="108px" OnSelectedIndexChanged="ddlrole_SelectedIndexChanged" AutoPostBack="True">
                       </asp:DropDownList>
                    </td>
               </tr>
         ...
         <tr>
                   ...
                   <td style="width: 224px; height: 54px;" class="tdheight">
                       <asp:TextBox ID="tbxConfirmPassword" runat="server" CssClass="textbox" MaxLength="20" TextMode="Password" Width="108px" Height="20px"></asp:TextBox>
                ...
                <tr>
                   ...
                   <td style="width: 96px" class="tdheight">
                    ...
                    <td><asp:Button ID="Button1" runat="server" Text="<%$ Resources:DashboardText,Insert %>" OnClick="Button1_Click" CssClass="pagebutton" Height="34px"/><asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Icons/Left-arrow.png" OnClick="ImageButton1_Click1" style="height: 25px" /></td>
               </tr>
                <tr>
                   <td style="width: 144px">
                       &nbsp;</td>
