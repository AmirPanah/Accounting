<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="LecturersManagment.aspx.cs" Inherits="personweb.LecturersManagment" %>
     ...
     <table style="border: 1px groove #000099; width: 90%" class="tableborder" dir="rtl">
                 ...
                 <tr class="tableheaderback">
                    <td   style=" height: 40px;" class="tableheaderback" >
                        <asp:Label ID="Label4" runat="server" CssClass="lblheader" Text="<%$ Resources:DashboardText,ManageLecture%>"></asp:Label>
                     </td>
                </tr>
                ...
                <tr>
                        ...
                        <asp:GridView ID="GridView1" runat="server" OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False" PageSize="5" Width="98%" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="True" style="margin-top: 0px" >
                            ...
                            <Columns>
                                <asp:BoundField DataField="LecturerID" HeaderText="کد استاد " >
                                ...
                                <asp:TemplateField HeaderText="تماس">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="HyperLink1" runat="server" ImageUrl="~/Icons/tel.jpg" Target="_blank" NavigateUrl='<%#"TelManagment/2/" + Eval("LecturerID").ToString() %>'>HyperLink</asp:HyperLink>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="ایمیل">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="HyperLink2" runat="server" ImageUrl="~/Icons/email2.png" Target="_blank" NavigateUrl='<%#"EmailManagment/2/" + Eval("LecturerID").ToString() %>'>HyperLink</asp:HyperLink>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="ویرایش">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="HyperLink3" runat="server" ImageUrl="~/Icons/EditIcon.png" Target="_blank" NavigateUrl='<%#"EditLecturer/" + Eval("LecturerID").ToString() %>'>HyperLink</asp:HyperLink>
                                    </ItemTemplate>
            ...
            <SortedDescendingHeaderStyle BackColor="#6F8DAE" />
                 ...
                 <tr>
                    <td>
                        ...
                        <asp:Button ID="Button1" runat="server" Text="<%$ Resources:DashboardText,InsertLecturer %>" OnClick="Button1_Click" CssClass="pagebutton"/>
                 ...
                 <tr>
                    <td>
                        ...
                        <asp:DropDownList ID="DropDownList1" runat="server" Height="16px" Width="79px">
                            <asp:ListItem Value="0">کد استاد</asp:ListItem>
