<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RolesManagment.aspx.cs" Inherits="personweb.RolesManagment" %>
     ...
     <table style="border: 1px groove #000099; width: 90%" class="tableborder" dir="rtl">
                 ...
                 <tr class="tableheaderback">
                    <td   style=" height: 40px;" class="tableheaderback" >
                        <asp:Label ID="Label4" runat="server" CssClass="lblheader" Text="<%$ Resources:DashboardText,ManageRole%>"></asp:Label>
                     </td>
                </tr>
                ...
                <tr>
                        ...
                        <asp:GridView ID="GridView1" runat="server" OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False" PageSize="5" Width="90%" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="True" >
                            ...
                            <Columns>
                                <asp:BoundField DataField="RoleID" HeaderText="کد سمت " >
                                ...
                                <asp:TemplateField HeaderText="ویرایش">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="HyperLink1" runat="server" ImageUrl="~/Icons/EditIcon.png" Target="_blank" NavigateUrl='<%#"EditRole/" + Eval("RoleID").ToString() %>'>HyperLink</asp:HyperLink>
                                    </ItemTemplate>
            ...
            <SortedDescendingHeaderStyle BackColor="#6F8DAE" />
                 ...
                 <tr>
                    <td>
                        ...
                        <asp:Button ID="Button1" runat="server" Text="<%$ Resources:DashboardText,InsertRole %>" OnClick="Button1_Click" CssClass="pagebutton"/>
                 ...
                 <tr>
                    <td>
                        ...
                        <asp:DropDownList ID="DropDownList1" runat="server" Height="16px" Width="79px">
                            <asp:ListItem Value="0">کد سمت</asp:ListItem>
                            <asp:ListItem Value="1">نام&nbsp; سمت</asp:ListItem>
                        </asp:DropDownList>
