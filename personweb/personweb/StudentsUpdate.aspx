<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="StudentsUpdate.aspx.cs" Inherits="personweb.StudentsUpdate" %>
      ...
      <table  style="border: 1px groove #000099; width:90%" class="tableborder" dir="rtl">
                 ...
                 <tr class="tableheaderback">
                    <td colspan="3"   style=" height: 40px;" class="tableheaderback" >
                        <asp:Label ID="Label17" runat="server" CssClass="lblheader" Text="<%$ Resources:DashboardText,EditStudent%>"></asp:Label>
                     </td>
                </tr>
                <tr>
                   <td style="width: 144px; height: 40px;">
                       &nbsp;</td>
                   <td style="width: 225px; height: 40px;" class="tdheight">
                       &nbsp;</td>
                ...
                <tr>
                   <td style="width: 144px; height: 40px;">
                       <asp:Label ID="Label4" runat="server" Text="<%$ Resources:DashboardText,StudentCode%>"  CssClass="font_custom16"></asp:Label>
                    </td>
                   <td style="width: 225px; height: 40px;" class="tdheight">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <tr>
                   <td style="width: 144px; height: 41px;">
                       <asp:Label ID="Label9" runat="server" Text="<%$ Resources:DashboardText,LevelTitle%>"  CssClass="font_custom16"></asp:Label>
                    </td>
                   <td style="width: 225px; height: 41px;" class="tdheight">
                       <asp:Label ID="lbllevel" runat="server" ForeColor="Red" Text="Label"></asp:Label>
                    </td>
                    <td style="height: 41px">
                       <asp:DropDownList ID="ddllevel" runat="server" Height="18px" Width="109px" OnSelectedIndexChanged="ddllevel_SelectedIndexChanged" AutoPostBack="True">
                       </asp:DropDownList>
                    </td>
               </tr>
                <tr>
                ...
                <tr>
                   ...
                   <td style="width: 225px; height: 42px;" class="tdheight">
                ...
                <tr>
                   <td style="width: 144px; height: 40px;">
                       <asp:Label ID="Label12" runat="server" Text="<%$ Resources:DashboardText,EntryTerm%>"  CssClass="font_custom16"></asp:Label>
                    </td>
                   <td style="width: 225px; height: 40px;" class="tdheight">
                       <asp:RadioButtonList ID="RadioButtonList2" runat="server" RepeatDirection="Horizontal">
                           <asp:ListItem Value="0">نیمسال اول</asp:ListItem>
                           <asp:ListItem Value="1">نیمسال دوم</asp:ListItem>
                       </asp:RadioButtonList>
                    </td>
                    <td style="height: 40px">
                        &nbsp;</td>
                ...
                <tr>
                   ...
                   <td style="width: 225px; height: 45px;" class="tdheight">
                ...
                <tr>
                   ...
                   <td style="width: 225px; height: 54px;" class="tdheight">
          ...
          <tr>
                ...
                <tr>
                   ...
                   <td style="width: 225px; height: 15px;" class="tdheight">
                ...
                <tr>
                   <td style="width: 144px">
                       &nbsp;</td>
                   <td style="width: 225px" class="tdheight">
                       &nbsp;</td>
                    
                    <td><asp:Button ID="Button1" runat="server" Text="<%$ Resources:DashboardText,Insert %>" OnClick="Button1_Click" CssClass="pagebutton"/><asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Icons/Left-arrow.png" OnClick="ImageButton1_Click1" style="height: 25px; width: 25px;" /></td>
               </tr>
                <tr>
                   <td style="width: 144px">
                       &nbsp;</td>
