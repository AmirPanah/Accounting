<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TelContactsManagment.aspx.cs" Inherits="personweb.TelContactsManagment" %>
      ...
      <table style="border: 1px groove #000099; width: 90%" class="tableborder" dir="rtl">
                 ...
                 <tr class="tableheaderback">
                    <td   style=" height: 40px;" class="tableheaderback" >
                        <asp:Label ID="Label4" runat="server" CssClass="lblheader" Text="<%$ Resources:DashboardText,ManageTelContact%>"></asp:Label>
                     </td>
                </tr>
                ...
                <tr>
                        ...
                        <asp:GridView ID="GridView1" runat="server" OnPageIndexChanging="GridView1_PageIndexChanging" AutoGenerateColumns="False" PageSize="5" Width="90%" CellPadding="4" ForeColor="#333333" GridLines="None" AllowPaging="True" >
                            ...
                            <Columns>
                                <asp:BoundField DataField="ID" HeaderText="کد تماس " >
                                ...
                                <ItemStyle HorizontalAlign="Center" Width="75px" />
                                 ...
                                 <asp:BoundField DataField="TelNumber" HeaderText="شماره تماس"  >
                                <ItemStyle HorizontalAlign="Center" Width="75px" />
                               </asp:BoundField>

                                <asp:TemplateField HeaderText="ویرایش">
                                    <ItemTemplate>
                                        <asp:HyperLink ID="HyperLink1" runat="server" ImageUrl="~/Icons/EditIcon.png" Target="_blank" NavigateUrl='<%#"EditTelContact/" + Eval("ID").ToString() %>'>HyperLink</asp:HyperLink>
                                    </ItemTemplate>
            ...
            <SortedDescendingHeaderStyle BackColor="#6F8DAE" />
                 ...
                 <tr>
                    <td>
                        ...
                        <asp:Button ID="Button1" runat="server" Text="<%$ Resources:DashboardText,InsertTelContact %>" OnClick="Button1_Click" CssClass="pagebutton"/>
                      ...
                      <asp:Button ID="Button2" runat="server" Text="<%$ Resources:DashboardText,Delete %>" OnClick="Button2_Click"  OnClientClick="return confirm(document.getElementById('askDelete').getAttribute('value'));" CssClass="pagebutton"/>
                        ...
                        <asp:Button ID="Button3" runat="server" Text="<%$ Resources:DashboardText,Report %>" OnClick="Button3_Click2" CssClass="pagebutton"/>
                 ...
                 <tr>
                    <td>
                        ...
                        <asp:DropDownList ID="DropDownList1" runat="server" Height="16px" Width="79px">
                            <asp:ListItem Value="0">کد تماس</asp:ListItem>
                            <asp:ListItem Value="1">کد نوع کاربر</asp:ListItem>
                             <asp:ListItem Value="2">کد کاربر</asp:ListItem>
                             <asp:ListItem Value="3">کد نوع تماس</asp:ListItem>
                             <asp:ListItem Value="4">شماره تماس</asp:ListItem>
                        </asp:DropDownList>
