...
namespace personweb
{
    public partial class VPNsManagment : System.Web.UI.Page
    {
        ...
        {
            VPNsRepository vstdir = new VPNsRepository();

            if (vstdir.Getexeldata() != null)
            {
                DumpExcel(vstdir.Getexeldata(), "VPNs");
            }
        }

        protected void Button1_Click(object sender, EventArgs e)
        {
            Redirector.Goto(Redirector.PageName.AddVPNs);
        }
