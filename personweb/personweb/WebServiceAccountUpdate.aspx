<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WebServiceAccountUpdate.aspx.cs" Inherits="personweb.WebServiceAccountUpdate" %>
     ...
     <table  style="border: 1px groove #000099; width:90%" class="tableborder" dir="rtl">
                 ...
                 <tr class="tableheaderback">
                    <td colspan="3"   style=" height: 40px;" class="tableheaderback" >
                        <asp:Label ID="Label4" runat="server" CssClass="lblheader" Text="<%$ Resources:DashboardText,EditWebService%>"></asp:Label>
                     </td>
                </tr>
           ...
           <tr>
                   ...
                   <td style="width: 224px; height: 54px;" class="tdheight">
                       ...
                       <asp:CompareValidator ID="RequiredFieldValidator7" runat="server" ControlToCompare="tbxConfirmPassword" ControlToValidate="txtpass" ErrorMessage="<%$ Resources:DashboardText,errNoPasswordsAreNotMatch %>" ForeColor="Red" Text="*"></asp:CompareValidator>
                    </td>
                    <td style="height: 54px">&nbsp;</td>
               </tr>
